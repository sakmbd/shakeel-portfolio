...
export default defineConfig((/* ctx */) => {
  return {
    ...
    extras: [
      ...
      // 'roboto-font', // intentionally omitted: site uses a system-font stack (see src/css/app.scss) to avoid webfont cost

      'material-icons', // used by Quasar's own components (icons, close/expand affordances, etc.)
    ],
    ...
    build: {
      ...
      vueRouterMode: 'history', // available values: 'hash', 'history' — history mode for clean, SEO-friendly URLs (safe here because the site is built with SSG, so every route is prerendered to its own static HTML file)
      // vueRouterBase,
